...
def generate_launch_description():
    ...
    declare_map_yaml_cmd = DeclareLaunchArgument(
        'map',
        default_value=os.path.join(get_package_share_directory('sobits_slam'), 'map', 'research_map.yaml'),
    ...
    declare_research_mode_cmd = DeclareLaunchArgument(
        'research',
        default_value='False',
        description='Use research mode if true',
    )
    #############################################
    ...
    ld.add_action(declare_research_mode_cmd)
...
def declare_param_file(context, *args, **kwargs):
    ...
    research_value = LaunchConfiguration('research').perform(context)
    if ((research_value == "True") or (research_value == "true")):
        param_file_path = os.path.join(get_package_share_directory('moving_obstacles_prediction'), 'param', robot_name_value, 'navigation_config_research.yaml')
    else:
        param_file_path = os.path.join(get_package_share_directory('moving_obstacles_prediction'), 'param', robot_name_value, 'navigation_config.yaml')
