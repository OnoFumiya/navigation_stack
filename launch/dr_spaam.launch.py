...
def generate_launch_description():
    param_file_arg = DeclareLaunchArgument(
        ...
        default_value=os.path.join(
            get_package_share_directory("moving_obstacles_prediction"),
            "config",
            "dr_spaam_param.yaml"
        ),
    )
    ...
    rviz_node = Node(
        ...
        name='research',
        output='screen',
        arguments=['-d', os.path.join(get_package_share_directory("moving_obstacles_prediction"), "rviz", "research.rviz")],
    )
